...
<head>
  ...
  <title>DCMA | Assigned Tasks</title>
...
<div class="wrapper">
  ...
  <?php $url = "/assigned-task.php"; include('sidebar.php');?>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Assigned Task</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example2" class="table table-sm table-bordered table-hover">
				  ...
				  $result=$con->prepare("SELECT * FROM tasks WHERE user_id = ? order by task_id DESC");
